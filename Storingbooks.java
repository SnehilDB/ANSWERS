    ...
    class Book_details
    {
        ...
        public static void main(String[] args)
        {
            try {
                ...
                BOOKS.General Book1 = new BOOKS.General(id, Book_name, Book_issued_to, Book_issue_date, Book_till_date);
                Book1.format_date(Book_issue_date, Book_till_date);
                System.out.println(Book1.fine());

                HashMap<Integer, BOOKS.General> hm = new HashMap<>();
                BOOKS.General b1 = new BOOKS.General(1, "A", "AA", "2017-07-29", "2017-09-29");
                BOOKS.General b2 = new BOOKS.General(2, "B", "BB", "2017-09-01", "2017-09-29");
                hm.put(1, b1);
                hm.put(2, b2);

                for (Map.Entry<Integer, BOOKS.General> entry : hm.entrySet()) {
                    int key = entry.getKey();
                    BOOKS.General b = entry.getValue();
