...
public class Books {
    ...
    public Books(int id, String Book_name, String Book_issued_to, String Book_issue_date, String Book_till_date)
    {
        this.Book_id=id;
...
class Book_details
{
    ...
    public static void main(String[] args)
    {
        try {
            ...
            Books Book1 = new Books(id, Book_name, Book_issued_to, Book_issue_date, Book_till_date);
            Book1.format_date(Book_issue_date, Book_till_date);
            System.out.println(Book1.fine());

            HashMap<Integer, Books> hm = new HashMap<>();
            Books b1 = new Books(1, "A", "AA", "2017-07-29", "2017-09-29");
            Books b2 = new Books(2, "B", "BB", "2017-09-01", "2017-09-29");
            hm.put(1, b1);
            hm.put(2, b2);
